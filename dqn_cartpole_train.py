...
if __name__ == "__main__":
    ...
    print('Training')
    model_dqn = DQN('MlpPolicy', vec_env, verbose=0, device='cpu', tensorboard_log=logs_dir)

    for i in range(1, 31):
        model_dqn.learn(total_timesteps=10_000, reset_num_timesteps=False, tb_log_name='DQN', progress_bar=True)
        model_dqn.save(f'{models_dir}/{10_000 * i}')
    vec_env.close()
